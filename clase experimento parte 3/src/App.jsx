...
import Carrito from "./pages/Carrito"; // ✅ asegúrate que está en components si es modal
...
function App() {
  ...
  return (
    <Router>
      <Header carritoCount={carrito.length} toggleCarrito={toggleCarrito} isAuthenticated={isAuthenticated} usuarioActivo={usuarioActivo} setIsAuthenticated={setIsAuthenticated} setUsuarioActivo={setUsuarioActivo} />
      ...
      <main id="contenedor-productos">
        <Routes>
          ...
          <Route path="/login" element={<Login setIsAuthenticated={setIsAuthenticated} setUsuarioActivo={setUsuarioActivo} />} />
          <Route path="/register" element={<Register setIsAuthenticated={setIsAuthenticated} setUsuarioActivo={setUsuarioActivo} />} />

          {/* ⚠️ Ya NO necesitas la ruta /carrito si usas modal */}
          <Route
            path="/admin"
            element={
