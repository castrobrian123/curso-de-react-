...
function ModalCarrito({ cart, setCart, onClose }) {
  ...
  const generarPDF = () => {
    ...
    const alturaTotal = altoBase + cart.length * alturaProducto;

    const doc = new jsPDF({
      unit: "mm",
      format: [anchoHoja, alturaTotal],
    });
    ...
    autoTable(doc, {
      ...
      startY: 70,
      theme: "grid",
      styles: { fontSize: 12, halign: "center", cellPadding: 2 },
    ...
    <div className="modal-overlay">
      <div className="modal-carrito cards-mode">
        ...
        <div className="acciones-carrito">
          ...
          <button className="btn-agregar" onClick={handleConfirmar}>
            Confirmar compra
          </button>
        </div>
      </div>
